...
<br>
<jsp:include page="bannerSuperior.jsp"></jsp:include><br><br>
	...
	<form:form method="POST" modelAttribute="userForm" class="register-form" id="login-form">
		<form action="/signup" method="post">
			...
			<div class="form-group row">
				<label for="inputPassword3" class="col-sm-2 col-form">Nick</label>
				<div class="col-sm-5">
			...
			<div class="form-group row">
				<div class="btn-group">
					<div class="col-sm-7">
						<button type="submit" class="btn btn-block btn-primary" class="form-submit">Sign Up</button>
					</div>
					<div class="col-sm-7">
	...
	<c:if test="${noIguales}">
		<p>Las contraseñas tienen que coincidir
		<p>
	</c:if>
	<c:if test="${nickIguales}">
	 ...
	 <c:if test="${mailIguales}">
         <p>Ya se registro un usuario con ese mail
		<p>
